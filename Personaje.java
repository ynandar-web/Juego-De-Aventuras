 ...
 * Contiene los atributos y métodos comunes para todos los personajes (como
 * vida, inventario y recibir daño).
 */
public abstract class Personaje {
    ...
    /**
     * Método abstracto: cada tipo de personaje (Mago, Guerrero) definirá su
     * propio ataque especial.
     */
    ...
    public void restaurarVida(int n) {
        vida = Math.min(100, vida + n);
    }

    // Aumenta el daño base permanentemente
    public void aumentarDanio(int n) {
        danioBase += n;
    }

    // Resta vida asegurándose de que no baje de 0
    public void recibirDanio(int n) {
        vida = Math.max(0, vida - n);
    }
